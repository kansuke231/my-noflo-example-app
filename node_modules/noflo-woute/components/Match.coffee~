...
# uncomment the codes and delete lines right below if you want to use the original functionality
    ...
    @inPorts.in.on 'data', (data) =>
      ...
      if @matches
        ...
        for match in @matches
          ...
          matched = true if (url[1..] == match) # this is simple string matching
